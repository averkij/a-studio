  ...
  <div>
    ...
    <div v-else class="mt-5">
                  ...
                  <v-row justify="center" no-gutters>
                    <v-col class="text-left" cols="12">
                      <div class="d-table fill-height">
                        ...
                        <v-divider class="d-table-cell" vertical></v-divider>
                        <div
                          class="d-table-cell grey lighten-5 pl-2 pt-2 text-center"
                        >
                          <v-checkbox
                            hide-details
                            color="blue"
                            class="ma-1 pa-0"
                            v-model="conflictSplittedFrom[line].e"
                            @click.stop="markUnused('from', line)"
                          ></v-checkbox>
                        </div>
                      </div>
                    </v-col>
            ...
            <div v-for="(line, i) in unusedToLines" :key="i">
              <template>
                <div
                  v-show="
                    showAllTo == 'true' ||
                    (conflictSplittedTo[line] && !conflictSplittedTo[line].e)
                  "
                >
                  <v-row justify="center" no-gutters>
                    <v-col class="text-left" cols="12">
                      <div class="d-table fill-height">
                        ...
                        >
                          <v-checkbox
                            ...
                            color="blue"
                            class="ma-1 pa-0"
                            v-model="conflictSplittedTo[line].e"
                            @click.stop.prevent="markUnused('to', line)"
                          ></v-checkbox>
                        </div>
                      </div>
                    </v-col>
      ...
      <div v-else>
          ...
          <v-row>
            <v-col cols="12" sm="6">
              <DownloadPanel
                ...
                :isLoading="isLoading"
                :count="100"
                :countOrig="splitted[langCodeFrom].meta.lines_count"
              >
              </DownloadPanel>
            </v-col>
            <v-col cols="12" sm="6">
              <DownloadPanel
                ...
                :isLoading="isLoading"
                :count="100"
                :countOrig="splitted[langCodeTo].meta.lines_count"
              >
              </DownloadPanel>
            </v-col>
          </v-row>
        ...
        <v-btn class="primary mt-5" @click="downloadProcessingTmx()"
          ><v-icon left color="white">mdi-download</v-icon>Download</v-btn
        >
      </div>
    </div>
  </div>
